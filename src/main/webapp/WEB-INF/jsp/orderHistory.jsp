                  ...
                  <table class="table table-striped table-hover table-bordered text-center table-responsive">
                    <thead>
                      <tr>
                        ...
                        <th scope="col">Payment Card Type</th>
                        <th scope="col">Payment Card Expiration Date</th>
                        <th scope="col">Payment Card CVV</th>
                    ...
                    <tbody>
                      <c:forEach var="order" items="${orders}">
                        <tr>
                            <th class="align-middle" scope="row">${order.totalPrice}</th>
                            <td class="align-middle">${order.numTickets}</td>
                            <td class="align-middle">${order.payCard.cardType}</td>
                            <td class="align-middle">${order.payCard.expDate}</td>
                            <td class="align-middle">${order.payCard.cvv}</td>
