          ...
          <div class="container">
                    ...
                    <tbody>
                      <c:forEach var="movie" items="${movies}">
                        <tr>
                            ...
                            <td class="align-middle">${movie.filmRating}</td>
                            <td class="align-middle">${movie.cast}</td>
            ...
            <div class="row justify-content-center" style="padding-top:25px">
              <div class="col-8 text-center d-grid gap-1" style="width: 300px">
                  <a href="./addMovie" class="btn btn-block btn-lg btn-primary project-btn-primary">Add New Movie</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="${movie.movie_id}LongTitle">${movie.title} Synopsis</h5>
